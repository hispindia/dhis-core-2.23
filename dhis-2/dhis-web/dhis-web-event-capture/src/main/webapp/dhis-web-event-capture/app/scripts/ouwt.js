...
$(function ()
{
    ...
    //console.log('tree loader has started.');
});
...
function Selection()
{
    ...
    this.getSelectedOrgUnit = function(selected){
        
        selection.getOrganisationUnit(selected).done(function(item){
            //console.log('the selected is:  ', selected[0]);
            console.log('the selected is:  ', item[selected].n );
            return item[selected].n;
        });
    ...
    this.load = function ()
    {
        ...
        selection.ajaxOrganisationUnits( true, 'text' ).done(function( data ) {
            if ( data.indexOf( "<!DOCTYPE" ) != 0 ) {
                ...
                //console.log('the data I got with version only is:  ', data);
            ...
            if( should_update ) {
                selection.ajaxOrganisationUnits( false ).done(function( data ) {
                    ...
                    //console.log('the data I got when not version only is:  ', data);
