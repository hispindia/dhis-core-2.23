 ...
 */
(function(t) {
    var o = {tooltip: !1, tooltipOpts: {content: "%s | X: %x | Y: %y", xDateFormat: null, yDateFormat: null, monthNames: null, dayNames: null, shifts: {x: 10, y: 20}, defaultTheme: !0, onHover: function() {
            }}}, i = function(t) {
    ...
    i.prototype.init = function(o) {
        ...
        var e = new Date(1 * o);
        return t.plot.formatDate(e, i, this.tooltipOptions.monthNames, this.tooltipOptions.dayNames)
