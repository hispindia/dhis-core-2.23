                            ...
                            if (attributes['id'] === 'executionDate') {
                                ...
                                if (prStDe && prStDe.dataElement && prStDe.dataElement.valueType) {
                                    ...
                                    if (prStDe.dataElement.optionSetValue) {
                                        ...
                                        newInputField = '<span class="hideInPrint"><ui-select style="width: 90%;" theme="select2" ' + commonInputFieldProperty + ' d2-option-validator on-select="saveDatavalue(prStDes.' + fieldId + ', outerForm.' + fieldId + ')" >' +
