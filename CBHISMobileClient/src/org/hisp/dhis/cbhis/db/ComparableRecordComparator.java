 ...
 * @author abyotag_adm
 */
public class ComparableRecordComparator implements RecordComparator
{
    ...
    ComparableRecordComparator(int sortOrder)
    {
        switch (sortOrder) {
            case SORT_BY_ID:
            case SORT_BY_NAME:
    ...
    {
        AbstractModel comp1 = ModelRecordStore.recordToComparableRecord(rec1);
        AbstractModel comp2 = ModelRecordStore.recordToComparableRecord(rec2);
